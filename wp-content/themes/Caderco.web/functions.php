...
function Servicio() {
	...
	$labels = array(
		'name'                  => _x( 'Servicio ', 'Post Type General Name', 'nivel' ),
		'singular_name'         => _x( 'Servicio', 'Post Type Singular Name', 'nivel' ),
		'menu_name'             => __( 'Servicios', 'nivel' ),
		'name_admin_bar'        => __( 'Servicios', 'nivel' ),
		'archives'              => __( 'Archivo', 'nivel' ),
		'attributes'            => __( 'Atributos', 'nivel' ),
		'parent_item_colon'     => __( 'Artículo principal', 'nivel' ),
		'all_items'             => __( 'Todos los artículos', 'nivel' ),
